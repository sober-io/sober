# 012 --- sober-agent: Implementation Plan
...
**This checkpoint must pass before proceeding to plans 013–018.**

After plan 012 is complete, prove the full message→agent→LLM→response loop works
