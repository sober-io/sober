# 016 — Internal Scheduler & Service Communication
...
- `sober-api` is already a gRPC client of the agent (established in 013). This plan adds the scheduler as an additional gRPC target for the API.
