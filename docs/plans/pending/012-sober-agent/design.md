...
`011-sober-mcp/design.md`. This document covers `sober-agent` only.
...
- `sober-core` --- shared types, error handling, repo traits (MessageRepo, ConversationRepo, McpServerRepo)
